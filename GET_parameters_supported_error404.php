...
define('CLIENT_ID', 'f2cdeb8b697146488446cd98f4e9eb83'); // wprowadź Client_ID aplikacji
define('CLIENT_SECRET', '7mv07UuQfjElQtv9tdLVKMZuWVLlr7ZJTgWSnSiJyUPXtYXbhzYbPYgQ25dnZfNv'); // wprowadź Client_Secret aplikacji
...
function getParametersForCategory($token) {
    $headers = array("Authorization: Bearer {$token}",
     "Accept: application/vnd.allegro.public.v1+json");
    $url = "https://api.allegro.pl/sale/categories/0/parameters";
...
function main()
{
    ...
    $main_categories = getParametersForCategory($token);
